...
int main() {
    ...
    order = 10;
    energy_poly(tol, order, c, coeffs);
    ...
    order = 9;
    double lambda;
    fourier_poly(tol, order, c, lambda, coeffs);
    ...
    order = 20;
    tol = 0.00000001;
    spread_fourier_poly(tol, order, c, lambda, coeffs);
    ...
    tol = 0.00000001;
    int P = 3;
    spread_real_poly(P, tol, order, c, coeffs);
