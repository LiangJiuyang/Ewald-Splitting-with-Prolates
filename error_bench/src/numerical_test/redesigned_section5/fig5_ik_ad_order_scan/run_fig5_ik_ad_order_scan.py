...
def paths_for(
    ...
    if complete(case, dedicated):
        return dedicated, "current raw replacement Figure-5 force record"
    return dedicated, "current raw replacement Figure-5 force record"
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "deprecated compatibility flag; missing legacy records are always "
            "regenerated under raw/<case_id>/"
        ),
    )
